...
Description
===========
This tree contains a module for allocating contiguous memory space from
user mode in Linux.

Owner
=====
Niclas - Please consult with me before committing changes.

Dependencies
============
Needs a Linux 2.6 kernel, and a GCC tool chain that is verified with this
kernel. Verified to compile on Fedora Core 3 (x86) using Linux 2.6.11 and MV
Linux 4.0 Pro on arm_v5t_le platform.
...
Note! The kernel module itself (cmemk) uses the kernel's own build system and
doesn't follow this convention.

How to build for Bionic
=======================

In Rules.make, set ANDROID_DIR, and LINUXKERNEL_INSTALL_DIR and run:
